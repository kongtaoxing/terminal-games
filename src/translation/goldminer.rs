...
lazy_static! {
    pub static ref GOLDMINER_TRANSLATIONS: HashMap<&'static str, HashMap<Language, String>> = {
        ...
        m.insert("goldminer_title", goldminer_title);
        ...
        m.insert("hook_swing", hook_swing);
        ...
        m.insert("press_space", press_space);
        ...
        m.insert("catch_gold", catch_gold);
        ...
        m.insert("big_gold_points", big_gold_points);
        ...
        m.insert("small_gold_points", small_gold_points);
        ...
        m.insert("avoid_stones", avoid_stones);
        ...
        m.insert("collect_all_gold", collect_all_gold);
        ...
        m.insert("higher_levels", higher_levels);
        ...
        m.insert("faster_hook", faster_hook);
        ...
        m.insert("heavier_items", heavier_items);
        ...
        m.insert("more_obstacles", more_obstacles);
        ...
        m.insert("controls_title", controls_title);
        ...
        m.insert("space_control", space_control);
